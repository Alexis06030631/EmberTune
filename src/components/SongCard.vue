...
.song-card {
  ...
  .song-card-title {
    ...
    .skeleton-text {
      height: 16px;
      background: linear-gradient(90deg, var(--primary-bg) 25%, var(--primary-secondary) 50%, var(--tertiary-bg) 75%);
  ...
  .artwork-container {
    ...
    .artwork-loader {
      ...
      height: 140px;
      border-radius: 5px;
      background: linear-gradient(90deg, var(--primary-bg) 25%, var(--secondary-bg) 50%, var(--tertiary-bg) 75%);
      background-size: 200% 100%;
      animation: loading 1s infinite;
    }
